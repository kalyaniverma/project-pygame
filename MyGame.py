...
def create_character():
    ...
    What is ÿour character name?
    
    >""")
    global character_race
    while character_race is None:
        race_choice=input("""
        Choose your Character race from the below by entering the relevant number:
        1 - Elf
        2 - Dwarf
...
def create_character_skill_sheet():
    ...
    print("""
    Now let's determine your character skills, which you will use throughout the game.
    In this game your character has four skills:
    
    - Strength, which you will use in any combat or any strength test
    ...
    and whenever Life reaches reaches 0, your character dies.
    ...
    Here is your Character Skills Sheet:
    """)
...
def modify_skills():
    ...
    print("To modify your skills, roll a 6-face die for each of your skills, and the game will add your score to the relevant skill")
...
def Scene_1():
    ...
    while choice is None:
        ...
        2 - Turn right
        > """)
        if user_input=="1" or "turn left":
            choice="1"
            Scene_2()
        elif user_input=="2" or "turn right":
            choice="2"
            Scene_3()
        else:
            print("""
...
def skill_check():
    ...
    if roll+character_dexterity > 10:
        print("""
        You dodge stone and survive! Danger is not over though..
...
def combat():
    ...
    print("A horrible orc attack you!")
